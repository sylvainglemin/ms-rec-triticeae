...
#hist(log10(mydatacM$nb_complete_site),breaks=100)
...
result <- c(SPECIES,WINDOW,mean(mydatacM$piSyn),pi_est,fisinit,f_est,u1_est,s1_est,u2_est,s2_est,u3_est,s3_est,likNull,-minLik,likSat,R2deviance,R2efron)
