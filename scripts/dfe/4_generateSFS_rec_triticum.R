...
for(GENOME in c("A","B","D")) {
  ...
  data_triticum <- data_triticum[substr(data_rec$map,2,2)==GENOME,]
  data_focal <- read.table(paste("outputs/orthology/triticum/",SPECIES,"_Taestivum",GENOME,"_reciprocalbestblast.txt",sep=""),header=T)
  ...
  hist(mydata$n_cult)
  Nmin <- 18
  hist(mapped$recRate,breaks=200)
  abline(v=median(mapped$recRate,na.rm=T))
  THRESHOLDREC <- median(mapped$recRate,na.rm=T)
  ...
  FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum_",GENOME,"_total_polyDFE.txt",sep="")
  ...
  for(i in 1:Nboot) {
    ...
    FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum",GENOME,"_total_polyDFE_boot",i,".txt",sep="")
    write(x=c(1,1,Nmin),file=FILENAME,sep="\t",ncol=3)
    write(x=c(sfs_S,l_S),file=FILENAME,sep="\t",ncol=(length(sfs_S)+1),append = T)
    write(x=c(sfs_NS,l_NS),file=FILENAME,sep="\t",ncol=(length(sfs_NS)+1),append = T)
  }
  ...
  FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum",GENOME,"_mapped_polyDFE.txt",sep="")
  write(x=c(1,1,Nmin),file=FILENAME,sep="\t",ncol=3)
  write(x=c(sfs_S,l_S),file=FILENAME,sep="\t",ncol=(length(sfs_S)+1),append = T)
  write(x=c(sfs_NS,l_NS),file=FILENAME,sep="\t",ncol=(length(sfs_NS)+1),append = T)
  ...
  for(i in 1:Nboot) {
    ...
    FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum",GENOME,"_mapped_polyDFE_boot",i,".txt",sep="")
    write(x=c(1,1,Nmin),file=FILENAME,sep="\t",ncol=3)
    write(x=c(sfs_S,l_S),file=FILENAME,sep="\t",ncol=(length(sfs_S)+1),append = T)
    write(x=c(sfs_NS,l_NS),file=FILENAME,sep="\t",ncol=(length(sfs_NS)+1),append = T)
  }
  ...
  mydata <- merge(mapped,infocontig,by.x="gene",by.y="Contig_name")
  mydata <- mydata[mydata$recRate>THRESHOLDREC,]
  hist(mydata$n_cult)
  ...
  FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum",GENOME,"_highrec_polyDFE.txt",sep="")
  write(x=c(1,1,Nmin),file=FILENAME,sep="\t",ncol=3)
  write(x=c(sfs_S,l_S),file=FILENAME,sep="\t",ncol=(length(sfs_S)+1),append = T)
  write(x=c(sfs_NS,l_NS),file=FILENAME,sep="\t",ncol=(length(sfs_NS)+1),append = T)
  ...
  for(i in 1:Nboot) {
    ...
    FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum",GENOME,"_highrec_polyDFE_boot",i,".txt",sep="")
    write(x=c(1,1,Nmin),file=FILENAME,sep="\t",ncol=3)
    write(x=c(sfs_S,l_S),file=FILENAME,sep="\t",ncol=(length(sfs_S)+1),append = T)
    write(x=c(sfs_NS,l_NS),file=FILENAME,sep="\t",ncol=(length(sfs_NS)+1),append = T)
  }
  ...
  FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum",GENOME,"_lowrec_polyDFE.txt",sep="")
  write(x=c(1,1,Nmin),file=FILENAME,sep="\t",ncol=3)
  write(x=c(sfs_S,l_S),file=FILENAME,sep="\t",ncol=(length(sfs_S)+1),append = T)
  write(x=c(sfs_NS,l_NS),file=FILENAME,sep="\t",ncol=(length(sfs_NS)+1),append = T)
  ...
  for(i in 1:Nboot) {
    ...
    FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum",GENOME,"_lowrec_polyDFE_boot",i,".txt",sep="")
    write(x=c(1,1,Nmin),file=FILENAME,sep="\t",ncol=3)
    write(x=c(sfs_S,l_S),file=FILENAME,sep="\t",ncol=(length(sfs_S)+1),append = T)
    write(x=c(sfs_NS,l_NS),file=FILENAME,sep="\t",ncol=(length(sfs_NS)+1),append = T)
  }
  ...
  FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum",GENOME,"_WWSS_polyDFE.txt",sep="")
  write(x=c(1,1,Nmin),file=FILENAME,sep="\t",ncol=3)
  write(x=c(sfs_S,l_S),file=FILENAME,sep="\t",ncol=(length(sfs_S)+1),append = T)
  write(x=c(sfs_NS,l_NS),file=FILENAME,sep="\t",ncol=(length(sfs_NS)+1),append = T)
  ...
  FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum",GENOME,"_WS_polyDFE.txt",sep="")
  write(x=c(1,1,Nmin),file=FILENAME,sep="\t",ncol=3)
  write(x=c(sfs_S,l_S),file=FILENAME,sep="\t",ncol=(length(sfs_S)+1),append = T)
  write(x=c(sfs_NS,l_NS),file=FILENAME,sep="\t",ncol=(length(sfs_NS)+1),append = T)
  ...
  FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum",GENOME,"_SW_polyDFE.txt",sep="")
  write(x=c(1,1,Nmin),file=FILENAME,sep="\t",ncol=3)
  write(x=c(sfs_S,l_S),file=FILENAME,sep="\t",ncol=(length(sfs_S)+1),append = T)
  write(x=c(sfs_NS,l_NS),file=FILENAME,sep="\t",ncol=(length(sfs_NS)+1),append = T)
  ...
  FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum",GENOME,"_WWSS_HighRec_polyDFE.txt",sep="")
  write(x=c(1,1,Nmin),file=FILENAME,sep="\t",ncol=3)
  write(x=c(sfs_S,l_S),file=FILENAME,sep="\t",ncol=(length(sfs_S)+1),append = T)
  write(x=c(sfs_NS,l_NS),file=FILENAME,sep="\t",ncol=(length(sfs_NS)+1),append = T)
  ...
  FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum",GENOME,"_WS_HighRec_polyDFE.txt",sep="")
  write(x=c(1,1,Nmin),file=FILENAME,sep="\t",ncol=3)
  write(x=c(sfs_S,l_S),file=FILENAME,sep="\t",ncol=(length(sfs_S)+1),append = T)
  write(x=c(sfs_NS,l_NS),file=FILENAME,sep="\t",ncol=(length(sfs_NS)+1),append = T)
  ...
  FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum",GENOME,"_SW_HighRec_polyDFE.txt",sep="")
  write(x=c(1,1,Nmin),file=FILENAME,sep="\t",ncol=3)
  write(x=c(sfs_S,l_S),file=FILENAME,sep="\t",ncol=(length(sfs_S)+1),append = T)
  write(x=c(sfs_NS,l_NS),file=FILENAME,sep="\t",ncol=(length(sfs_NS)+1),append = T)
  ...
  FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum",GENOME,"_WWSS_LowHighRec_polyDFE.txt",sep="")
  write(x=c(1,1,Nmin),file=FILENAME,sep="\t",ncol=3)
  write(x=c(sfs_S,l_S),file=FILENAME,sep="\t",ncol=(length(sfs_S)+1),append = T)
  write(x=c(sfs_NS,l_NS),file=FILENAME,sep="\t",ncol=(length(sfs_NS)+1),append = T)
  ...
  FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum",GENOME,"_WS_LowRec_polyDFE.txt",sep="")
  write(x=c(1,1,Nmin),file=FILENAME,sep="\t",ncol=3)
  write(x=c(sfs_S,l_S),file=FILENAME,sep="\t",ncol=(length(sfs_S)+1),append = T)
  write(x=c(sfs_NS,l_NS),file=FILENAME,sep="\t",ncol=(length(sfs_NS)+1),append = T)
  ...
  FILENAME <- paste("outputs/dfe/sfs/triticum/",SPECIES,"/",SPECIES,"_Taestivum",GENOME,"_SW_LowRec_polyDFE.txt",sep="")
  write(x=c(1,1,Nmin),file=FILENAME,sep="\t",ncol=3)
  write(x=c(sfs_S,l_S),file=FILENAME,sep="\t",ncol=(length(sfs_S)+1),append = T)
  write(x=c(sfs_NS,l_NS),file=FILENAME,sep="\t",ncol=(length(sfs_NS)+1),append = T)
